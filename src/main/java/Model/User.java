...
public class User {
    ...
    private String  faceData;           // Base64-encoded face snapshot
    private boolean fingerprintEnabled; // true = user enrolled Windows Hello
    ...
    public User(int id, String nom, String prenom, String email, String mdp, Role role,
                ...
                String faceData, boolean fingerprintEnabled) {
        this.id = id; this.nom = nom; this.prenom = prenom;
        this.email = email; this.mdp = mdp; this.role = role;
    ...
    // ── keep old 14-arg constructor for backward compatibility ────────────────
    public User(int id, String nom, String prenom, String email, String mdp, Role role,
                String skills, String diplomas, String experience, String bio,
        ...
        this(id, nom, prenom, email, mdp, role, skills, diplomas, experience, bio,
                phone, isVerified, verificationCode, faceData, false);
    }
    ...
    public void    setFingerprintEnabled(boolean enabled)     { this.fingerprintEnabled = enabled; }
